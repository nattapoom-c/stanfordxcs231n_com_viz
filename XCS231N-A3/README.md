...
### Colab + `uv`
If your prefer Colab as your development environment, we have a tutorial [video](https://drive.google.com/file/d/11C4dHUx1jyzS0IfHeT4Ua_CS0LiAbyWy/view?usp=sharing) that will help you get started. For the Python package manager in the Colab environment, we offer support for both `uv` and `conda` with again preference for `uv`. 
- [How to setup Colab environment?](https://drive.google.com/file/d/11C4dHUx1jyzS0IfHeT4Ua_CS0LiAbyWy/view?usp=sharing)
