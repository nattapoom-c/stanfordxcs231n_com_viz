...
class GaussianDiffusion(nn.Module):
    ...
    def predict_start_from_noise(self, x_t, t, noise):
        """Get x_start from x_t and noise according to Eq.(4) and Eq.(15) of the paper.
        Args:
        ...
        ####################################################################
        # TODO:
        # Transform x_t and noise to get x_start according to Eq.(4) and Eq.(15).
    ...
    def predict_noise_from_start(self, x_t, t, x_start):
        """Get noise from x_t and x_start according to Eq. (4) of the paper.
        Args:
            x_t: (b, *) tensor. Noisy image.
            t: (b,) tensor. Time step.
            x_start: (b, *) tensor. Starting image.
        ...
        ####################################################################
        # TODO:
        # Transform x_t and noise to get x_start according to Eq.(4).
        # Look at the coeffs in `__init__` method and use the `extract` function.
        ####################################################################
        # ### START CODE HERE ###
        # ### END CODE HERE ###
    ...
    def p_losses(self, x_start, model_kwargs={}):
        ...
        ####################################################################
        # TODO:
        # Implement the loss function according to Eq. (12) of the paper.
